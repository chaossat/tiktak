...
func (x *DouyinPublishListRequest) Reset() {
	*x = DouyinPublishListRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_proto_publist_proto_msgTypes[0]
...
func (*DouyinPublishListRequest) Descriptor() ([]byte, []int) {
	return file_proto_publist_proto_rawDescGZIP(), []int{0}
}
...
func (x *DouyinPublishListResponse) Reset() {
	*x = DouyinPublishListResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_proto_publist_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*DouyinPublishListResponse) Descriptor() ([]byte, []int) {
	return file_proto_publist_proto_rawDescGZIP(), []int{1}
}
...
func (x *Video) Reset() {
	*x = Video{}
	if protoimpl.UnsafeEnabled {
		mi := &file_proto_publist_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*Video) Descriptor() ([]byte, []int) {
	return file_proto_publist_proto_rawDescGZIP(), []int{2}
}
...
func (x *User) Reset() {
	*x = User{}
	if protoimpl.UnsafeEnabled {
		mi := &file_proto_publist_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*User) Descriptor() ([]byte, []int) {
	return file_proto_publist_proto_rawDescGZIP(), []int{3}
}
...
var File_proto_publist_proto protoreflect.FileDescriptor

var file_proto_publist_proto_rawDesc = []byte{
	0x0a, 0x13, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2f, 0x70, 0x75, 0x62, 0x6c, 0x69, 0x73, 0x74, 0x2e,
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x0b, 0x64, 0x6f, 0x75, 0x79, 0x69, 0x6e, 0x2e, 0x63, 0x6f,
	0x72, 0x65, 0x22, 0x4c, 0x0a, 0x1b, 0x64, 0x6f, 0x75, 0x79, 0x69, 0x6e, 0x5f, 0x70, 0x75, 0x62,
	...
	0x4c, 0x69, 0x73, 0x74, 0x22, 0xe7, 0x01, 0x0a, 0x05, 0x56, 0x69, 0x64, 0x65, 0x6f, 0x12, 0x0e,
	0x0a, 0x02, 0x69, 0x64, 0x18, 0x01, 0x20, 0x02, 0x28, 0x03, 0x52, 0x02, 0x69, 0x64, 0x12, 0x29,
	0x0a, 0x06, 0x61, 0x75, 0x74, 0x68, 0x6f, 0x72, 0x18, 0x02, 0x20, 0x02, 0x28, 0x0b, 0x32, 0x11,
	...
	0x28, 0x08, 0x52, 0x0a, 0x69, 0x73, 0x46, 0x61, 0x76, 0x6f, 0x72, 0x69, 0x74, 0x65, 0x22, 0x91,
	...
	0x6f, 0x77, 0x32, 0x71, 0x0a, 0x07, 0x70, 0x75, 0x62, 0x6c, 0x69, 0x73, 0x68, 0x12, 0x66, 0x0a,
	0x0d, 0x70, 0x75, 0x62, 0x6c, 0x69, 0x73, 0x68, 0x5f, 0x76, 0x69, 0x64, 0x65, 0x6f, 0x12, 0x28,
	...
	0x6e, 0x73, 0x65, 0x22, 0x00, 0x42, 0x08, 0x5a, 0x06, 0x2e, 0x2e, 0x2f, 0x3b, 0x70, 0x62,
}

var (
	file_proto_publist_proto_rawDescOnce sync.Once
	file_proto_publist_proto_rawDescData = file_proto_publist_proto_rawDesc
)

func file_proto_publist_proto_rawDescGZIP() []byte {
	file_proto_publist_proto_rawDescOnce.Do(func() {
		file_proto_publist_proto_rawDescData = protoimpl.X.CompressGZIP(file_proto_publist_proto_rawDescData)
	})
	return file_proto_publist_proto_rawDescData
}

var file_proto_publist_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_proto_publist_proto_goTypes = []interface{}{
...
var file_proto_publist_proto_depIdxs = []int32{
	...
	0, // 2: douyin.core.publish.publish_video:input_type -> douyin.core.douyin_publish_list_request
	1, // 3: douyin.core.publish.publish_video:output_type -> douyin.core.douyin_publish_list_response
...
func init() { file_proto_publist_proto_init() }
func file_proto_publist_proto_init() {
	if File_proto_publist_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_proto_publist_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_proto_publist_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_proto_publist_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Video); i {
			case 0:
				return &v.state
			case 1:
		...
		file_proto_publist_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*User); i {
			case 0:
				return &v.state
			case 1:
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_proto_publist_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_proto_publist_proto_goTypes,
		DependencyIndexes: file_proto_publist_proto_depIdxs,
		MessageInfos:      file_proto_publist_proto_msgTypes,
	}.Build()
	File_proto_publist_proto = out.File
	file_proto_publist_proto_rawDesc = nil
	file_proto_publist_proto_goTypes = nil
	file_proto_publist_proto_depIdxs = nil
}
