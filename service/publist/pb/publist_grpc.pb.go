...
func (c *publishClient) PublishVideo(ctx context.Context, in *DouyinPublishListRequest, opts ...grpc.CallOption) (*DouyinPublishListResponse, error) {
	out := new(DouyinPublishListResponse)
	err := c.cc.Invoke(ctx, "/douyin.core.publish/publish_video", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Publish_PublishVideo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/douyin.core.publish/publish_video",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PublishServer).PublishVideo(ctx, req.(*DouyinPublishListRequest))
	}
...
var Publish_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "douyin.core.publish",
