...
func (x *DouyinRelationActionRequest) Reset() {
	*x = DouyinRelationActionRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_followaction_proto_msgTypes[0]
...
func (*DouyinRelationActionRequest) Descriptor() ([]byte, []int) {
	return file_followaction_proto_rawDescGZIP(), []int{0}
}
...
func (x *DouyinRelationActionResponse) Reset() {
	*x = DouyinRelationActionResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_followaction_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*DouyinRelationActionResponse) Descriptor() ([]byte, []int) {
	return file_followaction_proto_rawDescGZIP(), []int{1}
}
...
var file_followaction_proto_rawDesc = []byte{
	0x0a, 0x12, 0x66, 0x6f, 0x6c, 0x6c, 0x6f, 0x77, 0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x2e, 0x70,
	0x72, 0x6f, 0x74, 0x6f, 0x12, 0x13, 0x64, 0x6f, 0x75, 0x79, 0x69, 0x6e, 0x2e, 0x65, 0x78, 0x74,
	0x72, 0x61, 0x2e, 0x73, 0x65, 0x63, 0x6f, 0x6e, 0x64, 0x22, 0x8e, 0x01, 0x0a, 0x1e, 0x64, 0x6f,
	...
	0x6f, 0x5f, 0x75, 0x73, 0x65, 0x72, 0x5f, 0x69, 0x64, 0x18, 0x03, 0x20, 0x02, 0x28, 0x03, 0x52,
	0x08, 0x74, 0x6f, 0x55, 0x73, 0x65, 0x72, 0x49, 0x64, 0x12, 0x1f, 0x0a, 0x0b, 0x61, 0x63, 0x74,
	0x69, 0x6f, 0x6e, 0x5f, 0x74, 0x79, 0x70, 0x65, 0x18, 0x04, 0x20, 0x02, 0x28, 0x05, 0x52, 0x0a,
	...
	0x28, 0x09, 0x52, 0x09, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x4d, 0x73, 0x67, 0x32, 0x8b, 0x01,
	0x0a, 0x0c, 0x46, 0x6f, 0x6c, 0x6c, 0x6f, 0x77, 0x41, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x7b,
	0x0a, 0x0c, 0x46, 0x6f, 0x6c, 0x6c, 0x6f, 0x77, 0x41, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x33,
	...
	0x65, 0x73, 0x74, 0x1a, 0x34, 0x2e, 0x64, 0x6f, 0x75, 0x79, 0x69, 0x6e, 0x2e, 0x65, 0x78, 0x74,
	...
	0x5f, 0x72, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x42, 0x07, 0x5a, 0x05, 0x2e,
	0x2e, 0x2f, 0x70, 0x62,
}

var (
	file_followaction_proto_rawDescOnce sync.Once
	file_followaction_proto_rawDescData = file_followaction_proto_rawDesc
)

func file_followaction_proto_rawDescGZIP() []byte {
	file_followaction_proto_rawDescOnce.Do(func() {
		file_followaction_proto_rawDescData = protoimpl.X.CompressGZIP(file_followaction_proto_rawDescData)
	})
	return file_followaction_proto_rawDescData
}

var file_followaction_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_followaction_proto_goTypes = []interface{}{
...
var file_followaction_proto_depIdxs = []int32{
	0, // 0: douyin.extra.second.FollowAction.FollowAction:input_type -> douyin.extra.second.douyin_relation_action_request
	1, // 1: douyin.extra.second.FollowAction.FollowAction:output_type -> douyin.extra.second.douyin_relation_action_response
...
func init() { file_followaction_proto_init() }
func file_followaction_proto_init() {
	if File_followaction_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_followaction_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_followaction_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_followaction_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_followaction_proto_goTypes,
		DependencyIndexes: file_followaction_proto_depIdxs,
		MessageInfos:      file_followaction_proto_msgTypes,
	}.Build()
	File_followaction_proto = out.File
	file_followaction_proto_rawDesc = nil
	file_followaction_proto_goTypes = nil
	file_followaction_proto_depIdxs = nil
}
