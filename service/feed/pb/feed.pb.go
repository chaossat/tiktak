...
var file_proto_feed_proto_rawDesc = []byte{
	...
	0x36, 0x0a, 0x13, 0x64, 0x6f, 0x75, 0x79, 0x69, 0x6e, 0x5f, 0x66, 0x65, 0x65, 0x64, 0x5f, 0x72,
	...
	0x65, 0x73, 0x74, 0x54, 0x69, 0x6d, 0x65, 0x22, 0xa6, 0x01, 0x0a, 0x14, 0x64, 0x6f, 0x75, 0x79,
	...
	0x22, 0xe7, 0x01, 0x0a, 0x05, 0x56, 0x69, 0x64, 0x65, 0x6f, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64,
	...
	0x20, 0x02, 0x28, 0x08, 0x52, 0x08, 0x69, 0x73, 0x46, 0x6f, 0x6c, 0x6c, 0x6f, 0x77, 0x32, 0x58,
	0x0a, 0x04, 0x46, 0x65, 0x65, 0x64, 0x12, 0x50, 0x0a, 0x07, 0x47, 0x65, 0x74, 0x46, 0x65, 0x65,
	0x64, 0x12, 0x20, 0x2e, 0x64, 0x6f, 0x75, 0x79, 0x69, 0x6e, 0x2e, 0x63, 0x6f, 0x72, 0x65, 0x2e,
	...
	0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x42, 0x05, 0x5a, 0x03, 0x2f, 0x70, 0x62,
}
...
var file_proto_feed_proto_depIdxs = []int32{
	...
	0, // 2: douyin.core.Feed.GetFeed:input_type -> douyin.core.douyin_feed_request
	1, // 3: douyin.core.Feed.GetFeed:output_type -> douyin.core.douyin_feed_response
...
func (c *feedClient) GetFeed(ctx context.Context, in *DouyinFeedRequest, opts ...grpc.CallOption) (*DouyinFeedResponse, error) {
...
func (*UnimplementedFeedServer) GetFeed(context.Context, *DouyinFeedRequest) (*DouyinFeedResponse, error) {
...
func _Feed_GetFeed_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(FeedServer).GetFeed(ctx, req.(*DouyinFeedRequest))
	}
